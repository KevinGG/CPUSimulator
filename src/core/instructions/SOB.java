...
public class SOB extends Decoder{
public static final String OPCODE_VALUE = "010000";
	
	public SOB(String binString) {
		super(binString);
	}
	...
	public void Execute() {
		//get content from register
				...
				cR-=1;
				cpu.getRegister((int)register).setBits(Converter.longToBin(cR), 0);
				if(cR>0){
					cpu.PCFlag=false;
