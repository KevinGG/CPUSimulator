...
public class VADD extends Decoder{
public static final String OPCODE_VALUE = "100011";
//private static final Logger logger = Logger.getLogger(VADD.class.getName());
     public VADD(String binString){
    	 super(binString);
     }
     ...
     public void Execute(){
 		...
 		*/
 		if(!indirectEnabled){//I=0
 			long length=Converter.binToLong(cpu.getRegister(0).getBinString()); 			
 			System.out.println("markVadd");
